...
namespace Smart_home
{
    partial class Nikos_shoe_rack
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Ε Ξ Υ Π Ν Η     Π Α Π Ο Υ Τ Σ Ο Θ Η Κ Η";
            // 
            // button3
            // 
            ...
            this.button3.Text = "Προσθήκη νέου παπουτσιού ";
            ...
            this.button4.Text = "Προβολή παπουτσιών με βάση την κατηγορία και την κατάσταση ";
            ...
            this.button5.Text = "Προβολή παπουτσιών με βάση την κατηγορία και το χρώμα ";
            ...
            this.richTextBox3.Text = "Προσθέστε παπούτσι στην παπουτσοθήκη";
            ...
            this.richTextBox4.Text = "Προβολή παπουτσιών με βάση την κατηγορία και το χρώμα ";
            ...
            this.richTextBox6.Text = "Προβολή παπουτσιών με βάση την κατηγορία και την κατάσταση ";
            ...
            this.richTextBox1.Size = new System.Drawing.Size(204, 111);
            ...
            this.Load += new System.EventHandler(this.Nikos_shoe_rack_Load);
